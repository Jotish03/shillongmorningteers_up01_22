    const NoonTeerResult = require('../../model/PreviousResults/NoonTeerResult')
    ...
    const addNoonTeerResult = async (req, res) => {
        ...
        try {
            res.render("PreviewsResult/NoonTeerResult/AddTeerResult",{  docTitle:`Morning Previous Result`})
        } catch (error) {
           req.flash(
               'error_msg',
               error.message
