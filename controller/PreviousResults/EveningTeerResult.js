const EveningTeerResult = require('../../model/PreviousResults/EveningTeerResult')
...
const getEveningSearchTeerResult =  async(req, res) => {
    try{
     if(!req.body.startdate && !req.body.enddate){
         ...
         res.redirect("/eveningteerresult")
     }
     let result={}
...
const addEveningTeerResult = async (req, res) => {
    ...
    try {
        res.render("PreviewsResult/EveningTeerResult/AddTeerResult",{  docTitle:`Evening Teer Result`})
    } catch (error) {
        req.flash(
            'error_msg',
            error.message
...
const createEveningTeerResult = async (req, res) => {
    ...
    try {
        console.log(req.body.eveningteerresult)
